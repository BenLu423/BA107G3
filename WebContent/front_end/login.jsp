                ...
                <div class="content-top"></div>
               	  <div class="col-xs-12 col-sm-4 col-sm-offset-4 set-login">
                      ...
                      <form action="<%=request.getContextPath()%>/member/mem.do" method="POST" class="set-form">
                          ...
                          <div>  
                            <input type="submit" name="send" id="send" class="btn btn-default set-login-btn" value="登入">
                          </div>
						...
						<form action="<%=request.getContextPath()%>/member/mem.do" method="POST" class="set-form">
		                          <br>
		                          <div>  
		                            <input type="submit" name="getlinked_member_register" id="getlinked_member_register" class="btn btn-default set-login-btn" value="註冊">
		                          </div>
