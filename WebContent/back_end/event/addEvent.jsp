...
<table style="table-layout:fixed;">
	...
	<tr>
		...
		<img class="col-md-6" id="blah"  alt="" />
...
<script>
  ...
  <script>
							...
							$("#mbutton").click(function() {
									...
									$("input[name='eve_cnt']").val("給有「高學歷」、「高收入」、「高顏質」的你<br>活動流程 :<br>(1).猜猜我是誰：暖場活動快速認識彼此。 <br>(2).主題式換桌：2對2聊天，每回合15分鐘。 <br>(3).誰是金頭腦：男女互動快問快答，刺激又有趣。 <br>(1).透過簡單的小活動讓彼此打破初相識的隔閡。 <br>(2).2男2女主題換桌聊天，每回合20分鐘。 <br>(3).男女QA，用討論方式了解男女彼此的想法。 <br>女生為活動日當月壽星，優惠現折100元 <br>女生2-3人同行，優惠現折100元/每人 <br>《男生報名》需符合底下條件 <br>(1).27-40歲，單身未婚。大學/大專畢，穩定工作。 <br>(2).月薪５萬以上，有以結婚為前提交往的意願。 <br>(3).身高175公分以上。 <br>《女生報名》需符合底下條件 <br>(1).25-39歲，單身未婚。 <br>(2).有以結婚為前提交往的意願。 ");
