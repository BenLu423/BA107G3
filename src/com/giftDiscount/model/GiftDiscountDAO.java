...
public class GiftDiscountDAO implements GiftDiscountDAO_interface{
	...
	private static final String CURRENT_VALID_GIFT_STMT = "SELECT * FROM GIFT_DISCOUNT WHERE GIFT_NO=? AND (CURRENT_TIMESTAMP BETWEEN GIFTD_START AND GIFTD_END) AND GIFTD_AMOUNT>0";
	...
	private static final String TOTAL_STMT = "SELECT * FROM GIFT_DISCOUNT ORDER BY GIFTD_NO DESC";
