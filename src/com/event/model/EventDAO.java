...
public class EventDAO implements EventDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT EVE_NO, EVEC_NO, EVE_NAME, EVE_START, EVE_END,EVE_TIME, EVE_CNT, EVE_QUOTA, EVE_SITE, EVE_REGFEE, EVE_STS FROM EVENT ORDER BY EVE_NO DESC";
	private static final String GET_ALL_STMT_STS_ON = "SELECT eve_no, evec_no, eve_name, eve_start, eve_end,eve_time, eve_cnt, eve_quota, eve_site, eve_regfee, eve_sts FROM event WHERE eve_sts = '上架' order by eve_no DESC";
