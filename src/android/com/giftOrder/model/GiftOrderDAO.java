...
public class GiftOrderDAO implements GiftOrderDAO_interface {
	...
	public void insert(GiftOrderVO giftOrderVO, Map<GiftOrderDetailVO, List<GiftReceiveVOA>> giftOrderDetailMap) {
		...
		try {
			...
			Set<Entry<GiftOrderDetailVO, List<GiftReceiveVOA>>> set = giftOrderDetailMap.entrySet();
			GiftOrderDetailVO giftOrderDetailVO = null;
			List<GiftReceiveVOA> giftReceiveList = null;
			...
			for (Entry<GiftOrderDetailVO, List<GiftReceiveVOA>> giftOrderDetail : set) {
				...
				for (GiftReceiveVOA giftReceiveVO : giftReceiveList) {
