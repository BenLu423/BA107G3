...
public class EventService {
	...
	public EventVO addEvent(String evec_no, String eve_name, java.sql.Timestamp eve_start, java.sql.Timestamp eve_end,
			java.sql.Timestamp eve_time, String eve_cnt, byte[] eve_pic, Integer eve_quota, String eve_site,
			Integer eve_regfee, String eve_sts) {
	...
	public EventVO updateEvent(String eve_no, String evec_no, String eve_name, java.sql.Timestamp eve_start,
			java.sql.Timestamp eve_end, java.sql.Timestamp eve_time, String eve_cnt, byte[] eve_pic, Integer eve_quota,
			String eve_site, Integer eve_regfee, String eve_sts) {
